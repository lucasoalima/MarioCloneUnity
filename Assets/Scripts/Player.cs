...
public class Player : MonoBehaviour
{
    ...
    Vector3 CheckFloorRays (Vector3 pos){
        ...
        RaycastHit2D floorMiddle = Physics2D.Raycast (originLeft, Vector2.down , velocity.y * Time.deltaTime, floorMask);
        RaycastHit2D floorRight = Physics2D.Raycast (originLeft, Vector2.down , velocity.y * Time.deltaTime, floorMask);
